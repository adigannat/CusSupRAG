...
AWS Snowball accelerates moving offline data or remote storage to the cloud. With AWS Snowball, you can easily migrate petabytes of data to the cloud without limits in storage capacity or compute power. These devices are purpose-built for use in edge locations where network capacity is constrained or nonexistent and provide storage and computing capabilities in harsh environments.
